...
HD_PWD='D:/VerilogFile/CompLab/CompLab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CompLab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CompLab.tcl -notrace
