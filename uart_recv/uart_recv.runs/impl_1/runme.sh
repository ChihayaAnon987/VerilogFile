...
HD_PWD='D:/VerilogFile/uart_recv/uart_recv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_recv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_recv.tcl -notrace
