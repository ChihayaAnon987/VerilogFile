...
HD_PWD='D:/VerilogFile/uart_recv/uart_recv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_recv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_recv.tcl
